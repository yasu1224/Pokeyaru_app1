...
class BoxesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create box" do
    assert_difference('Box.count') do
      post boxes_url, params: { box: { name: @box.name, place: @box.place, release: @box.release } }
    end
  ...
  test "should update box" do
    patch box_url(@box), params: { box: { name: @box.name, place: @box.place, release: @box.release } }
